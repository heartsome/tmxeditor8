 ...
 * @since JDK1.6
 */
public interface TmxEditorOpenCloseListener {
	/**
	 * TmxEditor 打开 TMX file/DB 后通知监听者
	 * @param dataAccess
	 *            {@link AbstractTmxDataAccess};
	 */
	public void editorOpened(AbstractTmxDataAccess dataAccess);

	/**
	 * TmxEditor 关闭 TMX file/DB 后通知监听者 ;
	 */
