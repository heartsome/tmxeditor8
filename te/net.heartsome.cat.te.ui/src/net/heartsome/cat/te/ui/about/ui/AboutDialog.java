package net.heartsome.cat.te.ui.about.ui;
...
public class AboutDialog extends Dialog {
	...
	public AboutDialog(Shell parentShell) {
		super(parentShell);
		image = Activator.getImageDescriptor("images/help/about.bmp").createImage();
	}
	...
	protected Control createDialogArea(Composite parent) {
		...
		lblVersion.setText(Messages.getString("dialog.AboutDialog.lblVersion"));
