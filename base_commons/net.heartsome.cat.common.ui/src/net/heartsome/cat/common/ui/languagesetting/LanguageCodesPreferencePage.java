package net.heartsome.cat.common.ui.languagesetting;
...
public class LanguageCodesPreferencePage extends PreferencePage implements IWorkbenchPreferencePage {
	...
	private Image isBidiImage = Activator.getImageDescriptor("images/preference/system/is-bidi.png").createImage();
