...
public class AddTermToTBDialog extends TrayDialog {
	 ...
	 * @return ;
	 */
	public static synchronized AddTermToTBDialog getInstance(Shell parentShell, String srcText, String tgtText) {
		if (instance == null) {
	...
	protected void okPressed() {
		...
		int state = importer.executeImport(strTBX, srcLang, null);
