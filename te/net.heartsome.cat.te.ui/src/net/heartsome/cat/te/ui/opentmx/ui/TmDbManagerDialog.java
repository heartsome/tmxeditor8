 ...
 */
package net.heartsome.cat.te.ui.opentmx.ui;
...
public class TmDbManagerDialog extends TrayDialog {
    ...
    /**
     * 用于外部获取当前选中的DatabaseModelBean
     */
	private DatabaseModelBean beanForOutUse;
	...
	// TODO  need to update help Content
	@Override
	protected Control createHelpControl(Composite parent) {
		// ROBERTHELP 记忆库管理
		String language = CommonFunction.getSystemLanguage();
		final String helpUrl = MessageFormat.format(
				"/net.heartsome.cat.te.ui.help/html/{0}/ch04.html#conn_tm_id", language);
	...
	class TreeLableProvider extends LabelProvider {
		...
		public String getText(Object element) {
			if (element instanceof String) {
				...
				if (bean.getDbType().equals(Constants.DBTYPE_INTERNALDB) || bean.getDbType().equals(Constants.DBTYPE_SQLITE)) {
		...
		public Object[] getChildren(Object parentElement) {
			if (parentElement instanceof String) {
				...
				Collections.sort(servers, new Comparator<DatabaseModelBean>() {
					...
					public int compare(DatabaseModelBean o1,
							DatabaseModelBean o2) {
...
//		}
	...
	protected void okPressed() {
		...
		if(getSelectDbName()!=null){			
			currServer.setDbName(getSelectDbName());
			beanForOutUse = currServer;
		}else{
			beanForOutUse=null;
		}
		super.okPressed();				
	...
	public String getSelectDbName(){
		...
		while (it.hasNext()) {
			DatabaseManagerDbListBean dbBean = (DatabaseManagerDbListBean) it.next();
              return dbBean.getDbName();
		}
		return null;
	}
	
	public DatabaseModelBean  getDB(){
		return beanForOutUse;
	}
	@Override
