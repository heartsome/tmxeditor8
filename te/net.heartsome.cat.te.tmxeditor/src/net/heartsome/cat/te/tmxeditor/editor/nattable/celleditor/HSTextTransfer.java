 ...
 * @since JDK1.6
 */
public class HSTextTransfer extends ByteArrayTransfer {
	static final String MIME_TYPE = "custom/HSTextTransfer";
	final int MIME_TYPE_ID = registerType(MIME_TYPE);
	
	private static HSTextTransfer _instance = new HSTextTransfer();
	private HSTextTransfer() {}
	 ...
	 */	
	public static HSTextTransfer getInstance () {
		return _instance;
	}
