...
/**
 * The find result in NatTable
 * @author Jason
 * @version
 * @since JDK1.6
 */
public class FindReasult {

	private IRegion regin;
	private String tuIdentifier;

	public FindReasult(IRegion regin, String tuIdentifier) {
		this.regin = regin;
		this.tuIdentifier = tuIdentifier;
	}

	public IRegion getRegin() {
		return regin;
	}

	public void setRegin(IRegion regin) {
		this.regin = regin;
	}
