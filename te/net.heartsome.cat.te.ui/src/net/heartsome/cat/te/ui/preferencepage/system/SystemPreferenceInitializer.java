...
//			LOGGER.error("", e);
		...
		store.setDefault(IPreferenceConstants.TMX_EDITOR_FONT_NAME, fd.getName());
		int fontSize = fd.getHeight();
		store.setDefault(IPreferenceConstants.TMX_EDITOR_FONT_SIZE, fontSize < 13 ? 13 : fontSize);
