package net.heartsome.cat.te.ui.preferencepage.system;
...
import net.heartsome.cat.te.ui.Constants;
import net.heartsome.cat.te.ui.ImageConstants;
...
public class SystemPreferencePage extends PreferencePage implements IWorkbenchPreferencePage {
	...
	public static final String ID = "net.heartsome.cat.te.ui.preferencepage.system.SystemPreferencePage";
	...
	protected Control createContents(Composite parent) {
		...
		HsImageLabel imageLabel1 = new HsImageLabel(
				...
				Activator.getImageDescriptor(ImageConstants.PREFERENCE_SYS_UPDATE));
		...
		HsImageLabel imageLabel2 = new HsImageLabel(
				...
				Activator.getImageDescriptor(ImageConstants.PREFERENCE_SYS_LANGUAGE));
		...
		GridLayout cmpFontGl = new GridLayout(1, true);
...
//		matchViewFontSetting.setLayoutData(gd);
		...
		HsImageLabel imageLabel3 = new HsImageLabel(
				...
				Activator.getImageDescriptor(ImageConstants.PREFERENCE_SYS_USER));
	...
	public boolean performOk() {
		...
		String newUser = txtSystemUser.getText();
		if(newUser != null && newUser.length() != 0){
			preferenceStore.setValue(IPreferenceConstants.SYSTEM_USER, newUser);
		...
		JFaceResources.getFontRegistry().put(Constants.TMX_EDITOR_TEXT_FONT, fontData);
		preferenceStore.setValue(IPreferenceConstants.TMX_EDITOR_FONT_NAME, fontData[0].getName());
		preferenceStore.setValue(IPreferenceConstants.TMX_EDITOR_FONT_SIZE, fontData[0].getHeight());
		return true;
	}
	...
	private void setInitValues(boolean blnIsApplyDefault) {
		...
		if (blnIsApplyDefault) {
			...
			strEditorFontName = preferenceStore.getDefaultString(IPreferenceConstants.TMX_EDITOR_FONT_NAME);
			intEdutorFontSize = preferenceStore.getDefaultInt(IPreferenceConstants.TMX_EDITOR_FONT_SIZE);
		} else {
			...
			strEditorFontName = preferenceStore.getString(IPreferenceConstants.TMX_EDITOR_FONT_NAME);
			intEdutorFontSize = preferenceStore.getInt(IPreferenceConstants.TMX_EDITOR_FONT_SIZE);
		}
