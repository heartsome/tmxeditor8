...
#            CheckVersions.py
workspace_pathes = {
                    'felix_lu': '/Volumes/iMac-User/Documents/eclipse_ws/r8space_git',
                    'kevin': 'D:\\development\\workspace_git',
                    'Mac': '/Workspaces/tePackForIndigo',
                    }
...
#            CheckVersions.py
git_repo_pathes = {
                   'felix_lu': '/Volumes/iMac-User/Projects/hsgit/translation-studio',
                   'kevin': 'D:\\development\\git\\translation-studio',
                   'Mac': '/Users/Mac/r8PackGit/tePack/translation-studio',
                   }
...
build_copy_pathes = {
                    ...
                    'Mac': {
                    		   'all': ('/Document/pack_resources/build_files_te/documents', '.'),
                    		   'Win_x86_JRE': ('/Document/pack_resources/build_files_te/jre6u37_x86', '.'),
                    		   'Win_x64_JRE': ('/Document/pack_resources/build_files_te/jre6u37_x64', '.')
                    		},
                    }
...
target_platform_pathes = {
                          'felix_lu': (
                                       '/Volumes/iMac-User/Documents/eclipse_ws/targetPlatforms/targetPlatformBabel', 
                                       ),
