 ...
 * @since JDK1.6
 */
public class CleanTagsHandler extends AbstractHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		boolean confirm = MessageDialog.openConfirm(HandlerUtil.getActiveShell(event),
				Messages.getString("te.ui.cleanTagsHandler.warn.msg"),
				Messages.getString("te.ui.cleanTagsHandler.warn.desc"));
			...
			try {
				dialog.run(true, false, new IRunnableWithProgress() {
					...
					public void run(IProgressMonitor monitor) throws InvocationTargetException, InterruptedException {
						access.cleanDisplayTuInnerTag(monitor);
