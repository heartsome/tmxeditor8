 ...
 * @param <R>
 */
public class HorizontalRowSelectionModel<R> implements ISelectionModel {
	...
	public HorizontalRowSelectionModel(SelectionLayer selectionLayer, IRowIdAccessor rowIdAccessor) {
	...
	private Serializable getRowIdByPosition(int rowPosition) {
		return rowIdAccessor.getRowIdByPosition(rowPosition);
	}
