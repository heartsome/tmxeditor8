...
//									+ (VerticalNatTableConfig.ROW_SPAN - targetOriginRowPosition % VerticalNatTableConfig.ROW_SPAN);
							// Move up：将当前选中行显示完全
...
//						vBar.setIncrement(getRowHeightByPosition(0) * VerticalNatTableConfig.ROW_SPAN); // 设置滚动条增量为两倍行高
//
