...
public class MouseEditAction extends net.sourceforge.nattable.edit.action.MouseEditAction {
	...
	public void run(NatTable natTable, MouseEvent event) {
		...
		if (!xliffEditor.isHorizontalLayout()) {
			if (rowPosition != HsMultiActiveCellEditor.targetRowPosition
					&& rowPosition != HsMultiActiveCellEditor.sourceRowPosition) {
				HsMultiActiveCellEditor.commit(true);
				natTable.doCommand(new SelectCellCommand(natTable, columnPosition, rowPosition, withShiftMask,
						withCtrlMask));
