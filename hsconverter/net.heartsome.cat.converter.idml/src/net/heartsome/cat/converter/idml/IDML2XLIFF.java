...
//					将剩余的 story 文件放入压缩包
		 ...
		 *             ;
		 */
		private void parseSpreadFile(boolean isParseMasterSpread, IProgressMonitor monitor) throws XPathParseException,
		 ...
		 *             ;
		 */
		private void writeSegment(String strSrc) throws IOException {
