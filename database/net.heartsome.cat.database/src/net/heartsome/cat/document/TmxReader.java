...
public class TmxReader {
	...
	// File f = new File("d:\\IT_TM_SC.tmx");
	// try {
	// long l = System.currentTimeMillis();
	// File t = new File("d:\\test.tmx");
	// if (!t.exists()) {
	// t.createNewFile();
	// }
	// FileOutputStream fos = new FileOutputStream(t);
	// TmxReader r = new TmxReader(f);
	// TmxTU tu = null;
	// while ((tu = r.read()) != null) {
	//
	// StringBuffer bf = new StringBuffer();
	// bf.append("<tu");
	// if (tu.getCreationDate() != null) {
	// bf.append(" creationdate=\"" + tu.getCreationDate() + "\"");
	// }
	// if (tu.getCreationUser() != null) {
	// bf.append(" creationid=\"" + tu.getCreationUser() + "\"");
	// }
	// if (tu.getChangeDate() != null) {
	// bf.append(" changedate=\"" + tu.getChangeDate() + "\"");
	// }
	// if (tu.getChangeUser() != null) {
	// bf.append(" changeid=\"" + tu.getChangeUser() + "\"");
	// }
	// if (tu.getAttributes() != null) {
	// Iterator<String> it = tu.getAttributes().keySet().iterator();
	// while (it.hasNext()) {
	// String attrName = it.next();
	// String attrValue = tu.getAttributes().get(attrName);
	...
	// bf.append("<prop");
	// bf.append(" type=\"" + prop.getName() + "\"");
	// bf.append(">");
	// bf.append(prop.getValue());
	// bf.append("</prop>\n");
	// }
	//
	// TmxSegement tuv = tu.getSource();
	// if (tuv != null) {
	// bf.append("<tuv");
	// bf.append(" xml:lang=\"" + tuv.getLangCode() + "\">\n");
	// bf.append("<seg>" + tuv.getFullText() + "</seg>\n");
	// bf.append("</tuv>\n");
	// }
	// List<TmxSegement> tuvs = tu.getSegments();
	// for (TmxSegement _tuv : tuvs) {
	// bf.append("<tuv");
	// bf.append(" xml:lang=\"" + _tuv.getLangCode() + "\">\n");
	// bf.append("<seg>" + _tuv.getFullText() + "</seg>\n");
	// bf.append("</tuv>\n");
	// }
	// bf.append("</tu>\n\n");
